...
- [x] npm, Cargo, Tauri, Settings, MSI, and NSIS versions agree with the RC mapping.
...
- [ ] Offline mode preserves local telemetry, inventory, baseline, detections, score, and cached
...
- [x] English and Português (Brasil) on the real Tauri RC.
- [x] Sentinel Blue, Cyber Green, Terminal, and Spectrum on the real Tauri RC.
- [ ] 1920x1080, 1600x900, 1440x900, 1366x768, and 1280x720.
- [ ] Overview, System, Network, Activity, Inventory, Security Events, Detections, CVE Detail,
  Security Score, and Settings.
...
- [x] Tauri EXE, MSI, and NSIS generated as `UNSIGNED RELEASE CANDIDATE`.
